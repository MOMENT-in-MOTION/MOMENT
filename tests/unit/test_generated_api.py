...
from tests.unit.utils.setup_desciptors import DEFAULT_CONFIG
...
def generate_api_code(meta_model, api_config, formatter, _tmp_path=None):
...
class TestSetter:
    ...
    def test_explicit_type_safety_is_rendered(
        ...
        assert "Expected 'str'" in code or "Expected 'int'" in code
